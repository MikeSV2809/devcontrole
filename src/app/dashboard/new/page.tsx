        ...
        <Container>
            <main className="mt-9 mb-2">
                ...
                <form className="flex flex-col mt-6" action={handleRegisterTicket}>
                    ...
                    <input
                        className="w-full border-2 rounded-md px-2 mb-2 h-11 border-gray-300"
                        type="text"
                    ...
                    <textarea
                        className="w-full border-2 rounded-md px-2 mb-2 h-24 resize-none border-gray-300"
                    ...
                    {customers.length !== 0 && (
                        <>
                            ...
                            <select
                                className="w-full border-2 rounded-md px-2 mb-2 h-11 bg-white border-gray-300"
                                name="customer"
                            >
