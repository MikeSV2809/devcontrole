...
export function FormTicket({ customer }: FormTicketProps){
    ...
    return(
        <form className="bg-slate-200 mt-6 px-4 py-6 rounded border-2 border-gray-300" onSubmit={handleSubmit(handleRegisterTicket)}>
            ...
            <textarea
              className="w-full border-2 rounded-md h-24 bg-white resize-none px-2 border-gray-300"
