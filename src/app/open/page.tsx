...
export default function OpnenTicket() {
    ...
    return (
        <div className="w-full max-w-2xl mx-auto px-2 ">
            ...
            <main className="flex flex-col mt-4 mb-2">
                {customer ? (
                    <div className="bg-slate-200 py-6 px-4 rounded border-2 border-gray-300 flex items-center justify-between">
                    ...
                    <form className="bg-slate-200 py-6 px-2 rounded border-2 border-gray-300" onSubmit={handleSubmit(handleSearchCustomer)}>
                        <div className="flex flex-col gap-3">
                            ...
                            <button type="submit" className="bg-blue-500 flex flex-row gap-3 px-2 h-11 cursor-pointer items-center justify-center rounded text-white font-bold">
                                Procurar cliente
